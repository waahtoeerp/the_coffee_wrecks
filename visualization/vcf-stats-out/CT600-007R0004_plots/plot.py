...
#   plot-vcfstats -P -p /scratch/project_2019675/the_coffee_wrecks/visualization/vcf-stats-out/CT600-007R0004_plots/ /scratch/project_2019675/the_coffee_wrecks/visualization/vcf-stats-out/CT600-007R0004_stats.txt
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. CT600 .. /scratch/project_2019675/the_coffee_wrecks/gatk-out/CT600-007R0004_filtered.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='CT600')
    has_data = 1
