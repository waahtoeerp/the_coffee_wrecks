# Coffee Wrecks Pipeline

```mermaid
flowchart TD
    A["⚠️ bwa align + sort\n(script not in repo)"] -.-> B["bwa-out/SAMPLE_$
    B -.-> C["mapDamage_vrouw_maria.sh\n⚠️ MarkDuplicates block commented $
    C -.->|"BROKEN LINK:\ndedup.bam never created"| D["bwa-out/SAMPLE_ded$
    D -.-> E["mapDamage_rescale.sh"]
    E -.-> F["mapDamage-out/SAMPLE_mapDamage_dedup/\nSAMPLE_dedup.rescaled$
